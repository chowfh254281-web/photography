...
export default function LandscapePage() {
  ...
  // 根據截圖中的 20 張 Landscape 圖片重新分配
  const row1Images = ["DSC03300", "DSC04688", "DSC05456", "DSC05664", "DSC06114"];
  const row2Images = ["DSC07850", "DSC07975", "DSC07994", "DSC08153", "DSC08167-2"];
  const row3Images = ["DSC08358", "DSC08718", "DSC08748", "DSC08760", "DSC08810"];
  const row4Images = ["DSC08821", "DSC09972", "DSC09975", "DSC09982", "DSC03300"];
  const row5Images = ["DSC04688", "DSC05456", "DSC05664", "DSC06114", "DSC07850"];
  const row6Images = ["DSC07975", "DSC07994", "DSC08153", "DSC08167-2", "DSC08358"];
  const row7Images = ["DSC08718", "DSC08748", "DSC08760", "DSC08810", "DSC08821"];
  const row8Images = ["DSC09972", "DSC09975", "DSC09982", "DSC03300", "DSC04688"];
  const row9Images = ["DSC05456", "DSC05664", "DSC06114", "DSC07850", "DSC07975"];
    ...
    <>
      ...
      <nav className="smart-nav" id="navbar" onClick={toggleMenu}>
        ...
        <div className="nav-links">
          ...
          <Link href="/landscape" className="nav-item active">Landscape</Link>
      ...
      <div className="header-section">
        <h1 className="page-title">Landscape</h1>
        <div className="page-desc">The world is quiet here.</div>
      </div>
        ...
        <div className="mobile-track">
            <div className="gallery-strip" id="row-1" ref={row1Ref}>
                {row1Images.map((img, i) => (
                    <div key={i} className="strip-item"><img src={`/images/Landscape/${img}.jpg`} alt={img} /><div className="strip-caption">{String(i + 1).padStart(2, '0')}</div></div>
                ))}
                {/* SET 2 */}
                {row1Images.map((img, i) => (
                    <div key={`d2-${i}`} className="strip-item duplicate"><img src={`/images/Landscape/${img}.jpg`} alt={img} /></div>
                ))}
                {/* SET 3 */}
                {row1Images.map((img, i) => (
                    <div key={`d3-${i}`} className="strip-item duplicate"><img src={`/images/Landscape/${img}.jpg`} alt={img} /></div>
                ))}
            </div>
        </div>
        ...
        <div className="mobile-track">
            <div className="gallery-strip" id="row-2" ref={row2Ref}>
                {row2Images.map((img, i) => (
                    <div key={i} className="strip-item"><img src={`/images/Landscape/${img}.jpg`} alt={img} /><div className="strip-caption">{String(i + 6).padStart(2, '0')}</div></div>
                ))}
                {/* SET 2 */}
                {row2Images.map((img, i) => (
                    <div key={`d2-${i}`} className="strip-item duplicate"><img src={`/images/Landscape/${img}.jpg`} alt={img} /></div>
        ...
        <div className="mobile-track">
            <div className="gallery-strip" id="row-3" ref={row3Ref}>
                {row3Images.map((img, i) => (
                    <div key={i} className="strip-item"><img src={`/images/Landscape/${img}.jpg`} alt={img} /><div className="strip-caption">{String(i + 11).padStart(2, '0')}</div></div>
                ))}
                {/* SET 2 */}
                {row3Images.map((img, i) => (
                    <div key={`d2-${i}`} className="strip-item duplicate"><img src={`/images/Landscape/${img}.jpg`} alt={img} /></div>
        ...
        <div className="mobile-track">
            <div className="gallery-strip" id="row-4" ref={row4Ref}>
                {row4Images.map((img, i) => (
                    <div key={i} className="strip-item"><img src={`/images/Landscape/${img}.jpg`} alt={img} /><div className="strip-caption">{String(i + 16).padStart(2, '0')}</div></div>
                ))}
                {/* SET 2 */}
                {row4Images.map((img, i) => (
                    <div key={`d2-${i}`} className="strip-item duplicate"><img src={`/images/Landscape/${img}.jpg`} alt={img} /></div>
        ...
        <div className="mobile-track">
            <div className="gallery-strip" id="row-5" ref={row5Ref}>
                {row5Images.map((img, i) => (
                    <div key={i} className="strip-item"><img src={`/images/Landscape/${img}.jpg`} alt={img} /><div className="strip-caption">{String(i + 21).padStart(2, '0')}</div></div>
                ))}
                {/* SET 2 */}
                {row5Images.map((img, i) => (
                    <div key={`d2-${i}`} className="strip-item duplicate"><img src={`/images/Landscape/${img}.jpg`} alt={img} /></div>
        ...
        <div className="mobile-track">
            <div className="gallery-strip" id="row-6" ref={row6Ref}>
                {row6Images.map((img, i) => (
                    <div key={i} className="strip-item"><img src={`/images/Landscape/${img}.jpg`} alt={img} /><div className="strip-caption">{String(i + 26).padStart(2, '0')}</div></div>
                ))}
                {/* SET 2 */}
                {row6Images.map((img, i) => (
                    <div key={`d2-${i}`} className="strip-item duplicate"><img src={`/images/Landscape/${img}.jpg`} alt={img} /></div>
        ...
        <div className="mobile-track">
            <div className="gallery-strip" id="row-7" ref={row7Ref}>
                {row7Images.map((img, i) => (
                    <div key={i} className="strip-item"><img src={`/images/Landscape/${img}.jpg`} alt={img} /><div className="strip-caption">{String(i + 31).padStart(2, '0')}</div></div>
                ))}
                {/* SET 2 */}
                {row7Images.map((img, i) => (
                    <div key={`d2-${i}`} className="strip-item duplicate"><img src={`/images/Landscape/${img}.jpg`} alt={img} /></div>
        ...
        <div className="mobile-track">
            <div className="gallery-strip" id="row-8" ref={row8Ref}>
                {row8Images.map((img, i) => (
                    <div key={i} className="strip-item"><img src={`/images/Landscape/${img}.jpg`} alt={img} /><div className="strip-caption">{String(i + 36).padStart(2, '0')}</div></div>
                ))}
                {/* SET 2 */}
                {row8Images.map((img, i) => (
                    <div key={`d2-${i}`} className="strip-item duplicate"><img src={`/images/Landscape/${img}.jpg`} alt={img} /></div>
        ...
        <div className="mobile-track">
            <div className="gallery-strip" id="row-9" ref={row9Ref}>
                {row9Images.map((img, i) => (
                    <div key={i} className="strip-item"><img src={`/images/Landscape/${img}.jpg`} alt={img} /><div className="strip-caption">{String(i + 41).padStart(2, '0')}</div></div>
                ))}
                {/* SET 2 */}
                {row9Images.map((img, i) => (
                    <div key={`d2-${i}`} className="strip-item duplicate"><img src={`/images/Landscape/${img}.jpg`} alt={img} /></div>
